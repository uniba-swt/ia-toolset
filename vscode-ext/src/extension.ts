...
import { initDebugger } from './debugger/ia-debugger'
import { lsp } from './lsp/ia-lsp'
import { activateRefinementView } from './lsp/refinement-tree/refinement-view'
...
export function activate(context: vscode.ExtensionContext) {
    ...
    // product
    initProductView(context)

    // refinement
    activateRefinementView(context)
