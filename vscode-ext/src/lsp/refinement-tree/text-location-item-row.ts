...
export class TextLocationItemRow implements RefinementRow {
    transition: TextLocationItem
    refinementType: RefinementType

    constructor(transition: TextLocationItem, refinementType: RefinementType) {
